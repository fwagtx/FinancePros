...
':':'00000,01100,01100,00000,01100,01100,00000','?':'01110,10001,00001,00010,00100,00000,00100','^':'00100,00100,01110,01110,11111,11111,00000','v':'11111,11111,01110,01110,00100,00100,00000'};
...
function face(expr,mouth){var e='',m=MOUTH[mouth||'talk'];
...
function ticker(o){o=o||{};var id='t'+(uid++),expr=o.expr||'neutral',JK=o.jacket||C.navy,LP='#060920';
  ...
  '<g mask="url(#'+id+'m)" filter="url(#'+id+'g)">'+face(expr,o.mouth)+'</g>'+
